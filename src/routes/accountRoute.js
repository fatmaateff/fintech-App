...
const {AccountValidation, getAccountByIdValidation, transactionValidation} = require('../middlewares/validations/accountValidation');
// Routes for CRUD operations on accounts
router.route('/account')
    .post(AccountValidation, validator, openAccount)  // POST /api/account - Create a new account
...
router.route('/account/:id').all(getAccountByIdValidation,validator)
    ...
    .put(AccountValidation, validator, updateAccount)    // PUT /api/account/:id - Update account by ID
