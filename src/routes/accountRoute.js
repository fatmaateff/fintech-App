...
router.route('/account')
    .post(openAccount)  // POST /api/account - Create a new account
    .get(getAccounts);  // GET /api/account - Get all accounts

router.route('/account/:id')
    .get(getAccountById)   // GET /api/account/:id - Get account by ID
    .put(updateAccount)    // PUT /api/account/:id - Update account by ID
    .delete(deleteAccount); // DELETE /api/account/:id - Delete account by ID

// Routes for deposit and withdraw operations
router.post('/account/deposit/:id', deposit);   // POST /api/account/deposit/:id - Deposit funds into account
router.post('/account/withdraw/:id', withdraw); // POST /api/account/withdraw/:id - Withdraw funds from account
